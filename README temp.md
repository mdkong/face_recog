# AI를 활용한 얼굴인식 앱 만들기 프로젝트 
## _My First Project using ML, OpenCV etc._
...
- Python, Flask, MySOL, html etc,을 이용한 웹서비스를 개발
-- CSS, OpenCV, JavaScript
- Bootstrap5, OpenCV.js, Github, gh-pages 등을 이용하여 반응형 웹 개발로 변경
- drop images (requires your Dropbox account be linked)
